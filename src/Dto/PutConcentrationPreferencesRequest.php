...
class PutConcentrationPreferencesRequest
{
    /**
     * @var array<int,array{concentration:string,weight:int}>
     */
    #[Assert\NotNull]
    #[Assert\Type('array')]
    #[Assert\All(
        new Assert\Collection(
            fields: [
                'concentration' => new Assert\Required([new Assert\Type('string'), new Assert\NotBlank()]),
